...
namespace ApiClubMedv2.Migrations
{
    ...
    [Migration("20230313133051_AjoutTablesSupplemntairesBdClubMedS3")]
    partial class AjoutTablesSupplemntairesBdClubMedS3
    {
            ...
            modelBuilder.Entity("ApiClubMedv2.Models.EntityFramework.Reservation", b =>
                {
                    ...
                    b.Property<int>("fk_clb_rea")
                        .HasColumnType("integer");

                    b.Property<int>("fk_tch_rea")
                        .HasColumnType("integer");

                    b.Property<int?>("fk_trp_rea")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("fk_clb_rea");

                    b.HasIndex("fk_tch_rea");

                    b.HasIndex("fk_trp_rea");
